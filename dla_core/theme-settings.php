 ...
 */
function dla_core_default_theme_settings() {
  $defaults = array(
 ...
 */
function dla_core_initialize_theme_settings($theme_name) {
  ...
  if (!isset($theme_settings['primary_menu_dropdown']) || $theme_settings['rebuild_registry'] == 1) {
    ...
    $defaults = array_merge(dla_core_default_theme_settings(), $info_theme_settings);
...
function phptemplate_settings($saved_settings) {
  ...
  $form['tnt_container'] = array(
    '#type' => 'fieldset',
    '#title' => t('DLA Core theme settings'),
    '#description' => t('Use these settings to enhance the appearance and functionality of your DLA Core theme.'),
    '#collapsible' => TRUE,
    '#collapsed' => FALSE,
  );
  ...
  // Sidebar first width
  $form['tnt_container']['general_settings']['theme_grid_config']['left_width'] = array(
    '#type'          => 'select',
    '#title'         => t('Select a different width for your first sidebar'),
    '#default_value' => $settings['left_width'],
    '#options'       => $width_options,
  );
  $form['tnt_container']['general_settings']['theme_grid_config']['left_width']['#options'][$defaults['left_width']] .= t(' - Theme Default');
  // Sidebar last width
  $form['tnt_container']['general_settings']['theme_grid_config']['right_width'] = array(
    '#type'          => 'select',
    '#title'         => t('Select a different width for your last sidebar'),
    '#default_value' => $settings['right_width'],
    '#options'       => $width_options,
  );
  $form['tnt_container']['general_settings']['theme_grid_config']['right_width']['#options'][$defaults['right_width']] .= t(' - Theme Default');
